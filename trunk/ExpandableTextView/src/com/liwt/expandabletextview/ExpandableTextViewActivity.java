...
/**
 * https://github.com/lianghanzhen/ExpandableTextView/
 * 
...
public class ExpandableTextViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((ToggleButton) findViewById(R.id.enable_expand))
		...
		((ToggleButton) findViewById(R.id.change_lines))
				.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
					@Override
					public void onCheckedChanged(CompoundButton compoundButton,
							boolean checked) {
		...
		toggleView
				.setOnExpandListener(new ExpandableTextView.OnExpandListener() {
					@Override
		...
		((ExpandableTextView) findViewById(R.id.set_text_after_more_than_collapse_lines))
				.setText("Line #1: ExpandableTextView set text after\nLine #2: Collapse Lines is 3\nLine #3\nLine #4\nLine #5\nLine #6");
		((ExpandableTextView) findViewById(R.id.set_text_after_less_than_collapse_lines))
				.setText("Line #1: ExpandableTextView set text after\nLine #2: Collapse Lines is 3");
	}
